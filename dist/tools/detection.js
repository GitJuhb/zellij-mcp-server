...
export class DetectionTools {
     ...
     */
    static async watchPipe(pipePath, patterns, timeoutMs = 30000) {
        // Validate pipe path
     ...
     */
    static async createNamedPipe(pipeName, mode = '0666') {
        // Validate pipe name
     ...
     */
    static async pipeWithTimeout(command, targetPipe, timeoutMs = 30000) {
        // Validate command
     ...
     */
    static async pollProcess(pid, intervalMs = 1000) {
        // Validate PID
     ...
     */
    static async watchFile(filePath, patterns, timeoutMs = 30000) {
        // Validate file path
     ...
     */
    static async createLLMWrapper(wrapperName, llmCommand, detectMarker = '<<<LLM_COMPLETE>>>', timeoutMs = 60000) {
