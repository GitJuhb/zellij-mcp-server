...
class ZellijMCPServer {
            ...
            try {
                ...
                switch (name) {
                    ...
                    case 'zellij_attach_session':
                        return await this.attachSession(args?.session_name);
                    case 'zellij_new_session':
                        return await this.newSession(args?.session_name, args?.layout);
                    case 'zellij_kill_session':
                        return await this.killSession(args?.session_name);
                    case 'zellij_delete_session':
                        return await this.deleteSession(args?.session_name);
                    case 'zellij_get_session_info':
                        return await SessionTools.getSessionInfo(args?.session_name);
                    case 'zellij_export_session':
                        return await SessionTools.exportSession(args?.session_name, args?.output_path);
                    case 'zellij_import_session':
                        return await SessionTools.importSession(args?.import_path, args?.new_session_name);
                    case 'zellij_clone_session':
                        return await SessionTools.cloneSession(args?.source_session, args?.new_session_name);
                    case 'zellij_rename_session':
                        return await SessionTools.renameSession(args?.old_name, args?.new_name);
                    case 'zellij_switch_session':
                        return await SessionTools.switchSession(args?.session_name);
                    // Piping Tools
                    case 'zellij_pipe':
                        return await PipingTools.pipe(args?.payload, {
                            name: args?.pipe_name,
                            plugin: args?.plugin_url,
                            args: args?.args,
                            configuration: args?.configuration,
                        });
                    case 'zellij_pipe_to_plugin':
                        return await PipingTools.pipeToPlugin(args?.payload, args?.plugin_url, args?.pipe_name, args?.configuration);
                    case 'zellij_pipe_broadcast':
                        return await PipingTools.pipeBroadcast(args?.payload, args?.pipe_name);
                    case 'zellij_action_pipe':
                        return await PipingTools.actionPipe(args?.payload, {
                            name: args?.pipe_name,
                            plugin: args?.plugin_url,
                            forceLaunch: args?.force_launch,
                    ...
                    case 'zellij_pipe_with_response':
                        return await PipingTools.pipeWithResponse(args?.payload, {
                            name: args?.pipe_name,
                            plugin: args?.plugin_url,
                        });
                    case 'zellij_pipe_from_file':
                        return await PipingTools.pipeFromFile(args?.file_path, {
                            name: args?.pipe_name,
                            plugin: args?.plugin_url,
                        });
                    // Plugin Management
                    ...
                    case 'zellij_action_launch_plugin':
                        return await PluginTools.actionLaunchPlugin(args?.plugin_url, {
                            configuration: args?.configuration,
                            floating: args?.floating,
                            inPlace: args?.in_place,
                            skipCache: args?.skip_cache,
                    ...
                    case 'zellij_launch_or_focus_plugin':
                        return await PluginTools.launchOrFocusPlugin(args?.plugin_url, args?.configuration);
                    case 'zellij_start_or_reload_plugin':
                        return await PluginTools.startOrReloadPlugin(args?.plugin_url, args?.configuration);
                    case 'zellij_list_aliases':
                        return await PluginTools.listAliases();
                    case 'zellij_get_plugin_info':
                        return await PluginTools.getPluginInfo(args?.plugin_url);
                    case 'zellij_list_running_plugins':
                        return await PluginTools.listRunningPlugins();
                    // Layout Management
                    case 'zellij_dump_layout':
                        return await LayoutTools.dumpLayout(args?.output_path);
                    case 'zellij_save_layout':
                        return await LayoutTools.saveLayout(args?.layout_name, args?.layouts_dir);
                    case 'zellij_apply_layout':
                        return await LayoutTools.applyLayout(args?.layout_name, args?.session_name);
                    case 'zellij_list_layouts':
                        return await LayoutTools.listLayouts(args?.layouts_dir);
                    case 'zellij_load_layout':
                        return await LayoutTools.loadLayout(args?.layout_name, args?.layouts_dir);
                    case 'zellij_new_tab_with_layout':
                        return await LayoutTools.newTabWithLayout(args?.layout_name, args?.tab_name);
                    case 'zellij_validate_layout':
                        return await LayoutTools.validateLayout(args?.layout_path);
                    // Advanced Pane Operations
                    case 'zellij_new_pane':
                        return await PaneTools.newPane(args?.direction, args?.command, args?.cwd);
                    case 'zellij_close_pane':
                        return await this.closePaneOrTab('close-pane');
                    case 'zellij_swap_panes':
                        return await PaneTools.swapPanes(args?.direction);
                    case 'zellij_stack_panes':
                        return await PaneTools.stackPanes(args?.pane_ids);
                    ...
                    case 'zellij_dump_screen':
                        return await PaneTools.dumpScreen(args?.output_path);
                    case 'zellij_edit_scrollback':
                        return await PaneTools.editScrollback();
                    case 'zellij_rename_pane':
                        return await PaneTools.renamePane(args?.name);
                    case 'zellij_undo_rename_pane':
                        return await PaneTools.undoRenamePane();
                    case 'zellij_focus_pane':
                        return await PaneTools.moveFocus(args?.direction);
                    case 'zellij_move_focus_or_tab':
                        return await PaneTools.moveFocusOrTab(args?.direction);
                    case 'zellij_resize_pane':
                        return await this.resizePane(args?.direction, args?.amount);
                    case 'zellij_scroll':
                        return await PaneTools.scroll(args?.direction, args?.amount);
                    case 'zellij_scroll_to_edge':
                        return await PaneTools.scrollToEdge(args?.edge);
                    case 'zellij_exec_in_pane':
                        return await PaneTools.execInPane(args?.command);
                    case 'zellij_write_to_pane':
                        return await PaneTools.writeToPane(args?.text, args?.submit);
                    case 'zellij_get_pane_info':
                        return await PaneTools.getPaneInfo();
                    case 'zellij_change_floating_coordinates':
                        return await PaneTools.changeFloatingCoordinates(args?.x, args?.y, args?.width, args?.height);
                    // Tab Management
                    case 'zellij_new_tab':
                        return await this.newTab(args?.name, args?.layout);
                    case 'zellij_close_tab':
                        return await this.closePaneOrTab('close-tab');
                    case 'zellij_rename_tab':
                        return await this.renameTab(args?.name);
                    case 'zellij_undo_rename_tab':
                        return await this.undoRenameTab();
                    case 'zellij_go_to_tab':
                        return await this.goToTab(args?.index);
                    case 'zellij_go_to_tab_name':
                        return await this.goToTabName(args?.name);
                    case 'zellij_move_tab':
                        return await this.moveTab(args?.direction);
                    ...
                    case 'zellij_run_command':
                        return await this.runCommand(args?.command, args?.direction);
                    case 'zellij_edit_file':
                        return await this.editFile(args?.file_path);
                    case 'zellij_switch_mode':
                        return await this.switchMode(args?.mode);
                    ...
                    case 'zellij_watch_pipe':
                        return await DetectionTools.watchPipe(args?.pipe_path, args?.patterns, args?.timeout_ms);
                    case 'zellij_create_named_pipe':
                        return await DetectionTools.createNamedPipe(args?.pipe_name, args?.mode);
                    case 'zellij_pipe_with_timeout':
                        return await DetectionTools.pipeWithTimeout(args?.command, args?.target_pipe, args?.timeout_ms);
                    case 'zellij_poll_process':
                        return await DetectionTools.pollProcess(args?.pid, args?.interval_ms);
                    case 'zellij_watch_file':
                        return await DetectionTools.watchFile(args?.file_path, args?.patterns, args?.timeout_ms);
                    case 'zellij_create_llm_wrapper':
                        return await DetectionTools.createLLMWrapper(args?.wrapper_name, args?.llm_command, args?.detect_marker, args?.timeout_ms);
    ...
    async newSession(sessionName, layout) {
        const nameValidation = Validator.validateSessionName(sessionName);
        if (!nameValidation.valid) {
            throw new ValidationError(`Invalid session name: ${nameValidation.errors.join(', ')}`);
        }
    ...
    async resizePane(direction, amount) {
    ...
    async runCommand(command, direction) {
